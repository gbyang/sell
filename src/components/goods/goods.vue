<template>
  <div class="goods">
    <div class="menu-wrapper" ref="munu">
      <ul>
    ...
    <!-- ref属性使父组件可以调用子组件的方法 -->
    <shopcart ref="shop" :select-foods="selectFoods" :delivery-price="seller.deliveryPrice" :min-price="seller.minPrice"></shopcart>
    <food @add="drop" ref="food" :food="selectedFood"></food>
  </div>
</template>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      ...
      _initScroll () {
        this.menuScroll = new BScroll(this.$refs.munu, {
          click: true
        })
